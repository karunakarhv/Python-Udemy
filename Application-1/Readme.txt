...
Use Difflib module from standard builtin python library to check 
the closest match.
get_close_match is the method to check for the closest match
...
"SELECT Definition FROM Dictionary WHERE Expression = 'rain'"